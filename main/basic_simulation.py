...
GC = canvas.create_text(100, 40, text=cluster_coeff(r, fish_interaction_radius, N))
...
for t in range(4000):
    ...
    for j in range(N):
        ...
        interact = dist < fish_interaction_radius  # Vilka fiskar är inom en fisks interraktionsradie
        if sharkdists[j] < fish_interaction_radius:  # Om hajen är nära fisken, undvik hajen
    ...
    clustCoeff[t] = cluster_coeff(r, fish_interaction_radius, N)
